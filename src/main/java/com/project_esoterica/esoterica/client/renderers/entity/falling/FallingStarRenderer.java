...
public class FallingStarRenderer extends EntityRenderer<FallingEntity> {
    ...
    private static final ResourceLocation STAR = prefix("textures/vfx/uv_test.png");
    public static final RenderType STAR_TYPE = RenderTypes.createBootlegTriangleRenderType(StateShards.ADDITIVE_TRANSPARENCY, STAR);
