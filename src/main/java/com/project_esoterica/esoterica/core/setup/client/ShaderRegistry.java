...
public class ShaderRegistry {
    ...
    public static ExtendedShaderInstance radialNoise = new ExtendedShaderInstance();
    public static ExtendedShaderInstance radialScatterNoise = new ExtendedShaderInstance();
    ...
    public static void shaderRegistry(RegisterShadersEvent event) throws IOException {
        ...
        event.registerShader(new ShaderInstance(event.getResourceManager(), DataHelper.prefix("noise/radial_noise"), DefaultVertexFormat.POSITION_COLOR_TEX), shaderInstance -> radialNoise.setInstance(shaderInstance));
        event.registerShader(new ShaderInstance(event.getResourceManager(), DataHelper.prefix("noise/radial_scatter"), DefaultVertexFormat.POSITION_COLOR_TEX), shaderInstance -> radialScatterNoise.setInstance(shaderInstance));
