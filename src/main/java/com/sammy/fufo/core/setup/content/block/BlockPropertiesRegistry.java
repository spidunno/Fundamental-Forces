...
public class BlockPropertiesRegistry {
    ...
    public static OrtusBlockProperties ASTEROID_PROPERTIES() {
    ...
    public static OrtusBlockProperties CRUDE_COPPER_PROPERTIES() {
        return new OrtusBlockProperties(Material.METAL).sound(SoundType.COPPER).dynamicShape().isCutoutLayer();
    }

    public static OrtusBlockProperties CRUDE_IRON_PROPERTIES() {
        return new OrtusBlockProperties(Material.METAL).sound(SoundType.METAL).dynamicShape().isCutoutLayer();
    }

    public static OrtusBlockProperties CRUDE_PROPERTIES() {
        return new OrtusBlockProperties(Material.METAL).sound(SoundType.LODESTONE).dynamicShape().isCutoutLayer();
    }
