...
public class SpellRegistry {
    ...
    public static final SpellType FORCE_BOLT = registerSpellHolder(new SpellType(FufoMod.fufoPath("force_bolt"), (h) -> new SpellInstance(h, INSTANT, FORCE), (h) -> new SpellCooldown(40), new ProjectileEffect(SpellBolt::new).setDuration(100)));
