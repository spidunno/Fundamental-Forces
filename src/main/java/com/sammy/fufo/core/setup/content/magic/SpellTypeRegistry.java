...
public class SpellTypeRegistry {
    ...
    //public static final SpellType FORCE_BOLT = registerSpellType(new ProjectileSpell("fire_bolt", ElementTypeRegistry.FORCE, projectileSupplier));
    ...
    //public static final SpellType FIRE_BOLT = registerSpellType(new ProjectileSpell("fire_bolt", ElementTypeRegistry.FIRE, projectileSupplier));
    ...
    public static final SpellType FIREBALL = registerSpellType(new FireBolt());
    ...
    //public static final SpellType WATER_BOLT = registerSpellType(new ProjectileSpell("water_bolt", ElementTypeRegistry.WATER, projectileSupplier));
    ...
    //public static final SpellType ROCK_BOLT = registerSpellType(new ProjectileSpell("rock_bolt", ElementTypeRegistry.EARTH, projectileSupplier));
    ...
    //public static final SpellType AIR_BOLT = registerSpellType(new ProjectileSpell("air_bolt", ElementTypeRegistry.AIR, projectileSupplier));
