...
public class SpaceModRecipes extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        new ImpactConversionRecipeBuilder(Ingredient.of(Tags.Items.COBBLESTONE), Ingredient.of(AllBlocks.CHARRED_ROCK.get())).build(consumer, "cobblestone_charred_rock");
        ...
        new ImpactConversionRecipeBuilder(Ingredient.of(Tags.Items.STONE), Ingredient.of(AllBlocks.CHARRED_ROCK.get())).build(consumer, "stone_charred_rock");
        ...
        new ImpactConversionRecipeBuilder(Ingredient.of(Tags.Items.SAND), Ingredient.of(AllBlocks.VOLCANIC_GLASS.get())).build(consumer, "sand_volcanic_glass");
        ...
        new ManaAbsorbtionRecipeBuilder(Ingredient.of(Tags.Items.COBBLESTONE), Ingredient.of(AllBlocks.CHARRED_ROCK.get())).build(consumer, "cobblestone_charred_rock");
        new ManaAbsorbtionRecipeBuilder(Ingredient.of(Tags.Items.GLASS), Ingredient.of(AllBlocks.VOLCANIC_GLASS.get())).build(consumer, "glass_volcanic_glass");
        new ManaAbsorbtionRecipeBuilder(Ingredient.of(Tags.Items.SAND), Ingredient.of(AllBlocks.VOLCANIC_GLASS.get())).build(consumer, "sand_volcanic_glass");
        new ManaAbsorbtionRecipeBuilder(Ingredient.of(Items.GRASS_BLOCK), Ingredient.of(AllBlocks.SCORCHED_EARTH.get())).build(consumer, "grass_scorched_earth");
