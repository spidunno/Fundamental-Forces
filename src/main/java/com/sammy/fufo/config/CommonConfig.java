...
public class CommonConfig extends OrtusConfig {
    ...
    public static final OrtusConfig.ConfigValueHolder<Boolean> STARFALLS_ENABLED = new OrtusConfig.ConfigValueHolder<>(FUFO,"common/world_events/starfalls", (builder) ->
    ...
    public static final OrtusConfig.ConfigValueHolder<Integer> MAXIMUM_CHUNK_CHANGES = new OrtusConfig.ConfigValueHolder<>(FUFO,"common/world_events/starfalls", (builder) ->
    ...
    public static final OrtusConfig.ConfigValueHolder<Integer> STARFALL_SAFETY_RANGE = new OrtusConfig.ConfigValueHolder<>(FUFO,"common/world_events/starfalls", (builder) ->
    ...
    public static final OrtusConfig.ConfigValueHolder<Integer> STARFALL_MAXIMUM_TRIES = new OrtusConfig.ConfigValueHolder<>(FUFO,"common/world_events/starfalls", (builder) ->
    ...
    public static final OrtusConfig.ConfigValueHolder<List<? extends String>> STARFALL_ALLOWED_DIMENSIONS = new OrtusConfig.ConfigValueHolder<>(FUFO,"common/world_events/starfalls", (builder) ->
    ...
    public static final OrtusConfig.ConfigValueHolder<Integer> STARFALL_SPAWN_HEIGHT = new OrtusConfig.ConfigValueHolder<>(FUFO,"common/world_events/starfalls", (builder) ->
    ...
    public static final OrtusConfig.ConfigValueHolder<Integer> MAXIMUM_STARFALL_DISTANCE = new OrtusConfig.ConfigValueHolder<>(FUFO,"common/world_events/starfalls", (builder) ->
            builder.comment("Maximum distance away from a player to spawn an impact event")
                    .define("maximum_starfall_distance", 256));

    public static final OrtusConfig.ConfigValueHolder<Double> ASTEROID_CHANCE = new OrtusConfig.ConfigValueHolder<>(FUFO,"common/world_events/asteroids", (builder) ->
    ...
    public static final OrtusConfig.ConfigValueHolder<Integer> MAXIMUM_ASTEROID_AMOUNT = new OrtusConfig.ConfigValueHolder<>(FUFO,"common/world_events/asteroids", (builder) ->
    ...
    public static final OrtusConfig.ConfigValueHolder<Double> MINIMUM_ASTEROID_TIME_MULTIPLIER = new OrtusConfig.ConfigValueHolder<>(FUFO,"common/world_events/asteroids", (builder) ->
    ...
    public static final OrtusConfig.ConfigValueHolder<Double> MAXIMUM_ASTEROID_TIME_MULTIPLIER = new OrtusConfig.ConfigValueHolder<>(FUFO,"common/world_events/asteroids", (builder) ->
    ...
    public static final OrtusConfig.ConfigValueHolder<Integer> INITIAL_DEBRIS_COUNTDOWN = new OrtusConfig.ConfigValueHolder<>(FUFO,"common/world_events/space_debris", (builder) ->
            builder.comment("Base countdown for the very first space debris impact event")
                    .define("initial_space_debris_countdown", 100));

    public static final OrtusConfig.ConfigValueHolder<Integer> NATURAL_DEBRIS_COUNTDOWN = new OrtusConfig.ConfigValueHolder<>(FUFO,"common/world_events/space_debris", (builder) ->
            builder.comment("Base countdown for every subsequent space debris impact events")
                    .define("natural_space_debris_countdown", 500));

    public static final OrtusConfig.ConfigValueHolder<Double> MINIMUM_DEBRIS_COUNTDOWN_MULTIPLIER = new OrtusConfig.ConfigValueHolder<>(FUFO,"common/world_events/space_debris", (builder) ->
    ...
    public static final OrtusConfig.ConfigValueHolder<Double> MAXIMUM_DEBRIS_COUNTDOWN_MULTIPLIER = new OrtusConfig.ConfigValueHolder<>(FUFO,"common/world_events/space_debris", (builder) ->
    ...
    public static final OrtusConfig.ConfigValueHolder<Integer> MINIMUM_METEOR_FLAME_COST = new OrtusConfig.ConfigValueHolder<>(FUFO,"common/gameplay/meteor_flame", (builder) ->
            builder.comment("Minimum durability consumed to light a meteor rock on fire")
                    .define("minimum_durability_meteor_flame_cost", 8));

    public static final OrtusConfig.ConfigValueHolder<Integer> MAXIMUM_METEOR_FLAME_COST = new OrtusConfig.ConfigValueHolder<>(FUFO,"common/gameplay/meteor_flame", (builder) ->
