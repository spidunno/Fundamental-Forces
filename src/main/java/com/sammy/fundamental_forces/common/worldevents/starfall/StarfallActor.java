...
public class StarfallActor {
    ...
    public static BlockPos heightmapPosAt(Heightmap.Types type, ServerLevel level, BlockPos pos)
    {
        ...
        ForgeChunkManager.forceChunk(level, FundamentalForcesMod.MODID, pos,SectionPos.blockToSectionCoord(pos.getX()),SectionPos.blockToSectionCoord(pos.getZ()),false,false);
        return surfacePos;
    }
}