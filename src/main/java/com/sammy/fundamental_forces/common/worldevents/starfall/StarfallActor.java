...
import com.sammy.fundamental_forces.common.capability.FufoChunkDataCapability;
...
public class StarfallActor {
    ...
    public static boolean blockCheck(ServerLevel level, BlockState state) {
        TagKey<Block>[] tags = new TagKey[]{BlockTagRegistry.STARFALL_ALLOWED, OrtusBlockTags.TERRACOTTA, BlockTags.LUSH_GROUND_REPLACEABLE, BlockTags.MUSHROOM_GROW_BLOCK, BlockTags.LOGS, BlockTags.LEAVES, BlockTags.SNOW, BlockTags.SAND, Tags.Blocks.SANDSTONE};
