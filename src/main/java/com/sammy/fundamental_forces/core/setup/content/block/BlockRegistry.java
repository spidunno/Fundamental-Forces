...
import com.sammy.fundamental_forces.common.block.ScorchedEarthBlock;
...
import static com.sammy.fundamental_forces.core.setup.content.block.BlockPropertiesRegistry.*;

public class BlockRegistry {
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, FundamentalForcesMod.MODID);
