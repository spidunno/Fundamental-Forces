...
import com.sammy.fundamental_forces.core.setup.client.ShaderRegistry.ExtendedShaderInstance;
...
public class RenderHelper {
    ...
    public static void blit(PoseStack stack, ExtendedShaderInstance shader, int x, int y, double w, double h, float u, float v, float canvasSize) {
        innerBlit(stack, shader, x, y, w, h, u / canvasSize, v / canvasSize, (float) w / canvasSize, (float) h / canvasSize);
    }
    ...
    public static void vertexPosColor(VertexConsumer vertexConsumer, Matrix4f last, float x, float y, float z, int r, int g, int b, int a) {
        vertexConsumer.vertex(last, x, y, z).color(r, g, b, a).endVertex();
    }

    public static void vertexPosColorUV(VertexConsumer vertexConsumer, Matrix4f last, float x, float y, float z, int r, int g, int b, int a, float u, float v) {
        vertexConsumer.vertex(last, x, y, z).color(r, g, b, a).uv(u, v).endVertex();
    }

    public static void vertexPosColorUVLight(VertexConsumer vertexConsumer, Matrix4f last, float x, float y, float z, int r, int g, int b, int a, float u, float v, int light) {
