...
public class FufoCommandArguments {
    ...
    public static final RegistryObject<ArgumentTypeInfo<?, ?>> STARFALL_RESULT_ARGUMENT_INFO = ARGUMENT_TYPES.register("starfall_result", () -> ArgumentTypeInfos.registerByClass(StarfallResultArgumentType.class, SingletonArgumentInfo.contextFree(StarfallResultArgumentType::new)));
}
