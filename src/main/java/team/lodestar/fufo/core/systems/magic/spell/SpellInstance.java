package team.lodestar.fufo.core.systems.magic.spell;
...
import team.lodestar.fufo.core.systems.magic.spell.attributes.effect.SpellEffect;
...
public class SpellInstance {
    ...
    public SpellInstance setCooldown(ServerPlayer player) {
        ...
        FufoPlayerDataCapability.getCapabilityOptional(player).ifPresent(c -> PacketRegistry.INSTANCE.send(PacketDistributor.PLAYER.with(() -> player), new SyncSpellCooldownPacket(player.getUUID(), c.hotbarHandler.spellHotbar.getSelectedSpellIndex(player), cooldown)));
        return this;
    }
